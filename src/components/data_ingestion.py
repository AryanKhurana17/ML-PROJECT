...
class DataIngestionConfig:    #input given , later : will save our train file here
    train_data_path : str=os.path.join('artifact',"train.csv")    #artifacts is a folder
...
#python -m src.components.data_ingestion --> use -m to run this file . Why? It will search for modules inside this directory and not in sys
